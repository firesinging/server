...
namespace Libraries.packages.chat
{
    ...
    /// <summary>
    /// Reads content packet PacketBBotNetBasePacketChatDataRequest.
    /// </summary>
    public class PacketBBotNetBasePacketChatDataRequest
    {
        ...
        public PacketBBotNetBasePacketChatDataRequest(byte[] request)
        {
        ...
        public sealed override string ToString()
        {
            ...
            return string.Format(
                "PacketBBotNetBasePacketChatDataRequest\r\n" +
                "ChannelName = {0}\r\n" +
                "PlayerName = {1}\r\n" +
                "ChatMessage = {2}\r\n",
                ChannelName,
