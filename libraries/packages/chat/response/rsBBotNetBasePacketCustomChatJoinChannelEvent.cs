...
namespace Libraries.packages.chat
{
    ...
    /// Packet type 1.
    /// </summary>
    public class PacketBBotNetBasePacketCustomChatJoinChannelEvent
    {
        ...
        public PacketBBotNetBasePacketCustomChatJoinChannelEvent(string channelName, string playerName)
        {
        ...
        public sealed override string ToString()
        {
            ...
            return string.Format(
                "PacketBBotNetBasePacketCustomChatJoinChannelEvent\r\n" +
                "ChannelName = {0}\r\n" +
                "PlayerName = {1}\r\n",
                ChannelName,
                PlayerName
