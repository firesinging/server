...
namespace Libraries.packages.chat
{
    ...
    /// Packet type 14.
    /// </summary>
    public class PacketBBotNetBasePacketChatDataResponse
    {
        ...
        public PacketBBotNetBasePacketChatDataResponse(string channelName, string playerName, string chatMessage)
        {
        ...
        public sealed override string ToString()
        {
            ...
            return string.Format(
                "PacketBBotNetBasePacketChatDataResponse\r\n" +
                "ChannelName = {0}\r\n" +
                "PlayerName = {1}\r\n" +
                "ChatMessage = {2}\r\n",
                ChannelName,
