...
namespace Libraries.database.models
{
    ...
    /// <summary>
    /// Questgiver base override model
    /// </summary>
    /// <seealso cref="http://xmltocsharp.azurewebsites.net/"/>

    [XmlRoot(ElementName = "questgiver")]
    public class QuestgiverBaseOverride : ModelBase
    {

        public QuestgiverBaseOverride()
        {

            Overrides = new ModelQuestgiverOverridesReplacement();
        ...
        public ModelQuestgiverOverridesReplacement Overrides { get; set; }
