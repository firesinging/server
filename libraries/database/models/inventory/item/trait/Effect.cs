...
namespace Libraries.database.models.inventory.item.traits
{
    ...
    /// <summary>
    /// Inventory item effect model
    /// </summary>
    /// <seealso cref="http://xmltocsharp.azurewebsites.net/"/>

    [XmlRoot(ElementName = "effect")]
    public class ModelInventoryItemTraitEffectsEffect
    {

        public ModelInventoryItemTraitEffectsEffect()
        {

            Target = new ModelInventoryItemTraitEffectsEffectTarget();
            
        }

        [XmlElement(ElementName = "target")]
        public ModelInventoryItemTraitEffectsEffectTarget Target { get; set; }
