...
using Libraries.database.models.inventory.item.design;


namespace Libraries.database.models.inventory.item
{
    /// <summary>
    /// Inventory item design model
    /// </summary>
    /// <seealso cref="http://xmltocsharp.azurewebsites.net/"/>

    [XmlRoot(ElementName = "econdesign")]
    public class ModelInventoryItemDesign
    {

        public ModelInventoryItemDesign()
        {

            Input = new ModelInventoryItemDesignInput();
            Output = new ModelInventoryItemDesignOutput();
            Sellcostoverride = new ModelGenericSellcostoverride();
        ...
        public ModelInventoryItemDesignOutput Output { get; set; }
        ...
        public ModelInventoryItemDesignInput Input { get; set; }
