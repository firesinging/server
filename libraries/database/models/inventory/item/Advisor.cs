...
using Libraries.database.models.inventory.item.advisor;
...
namespace Libraries.database.models.inventory.item
{
    ...
    /// <summary>
    /// Inventory item advisor model
    /// </summary>
    /// <seealso cref="http://xmltocsharp.azurewebsites.net/"/>

    [XmlRoot(ElementName = "advisor")]
    public class ModelInventoryItemAdvisor
    {

        public ModelInventoryItemAdvisor()
        {

            Techs = new ModelInventoryItemAdvisorTechs();
        ...
        public ModelInventoryItemAdvisorTechs Techs { get; set; }
