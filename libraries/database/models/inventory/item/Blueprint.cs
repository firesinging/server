...
using Libraries.database.models.inventory.item.blueprint;


namespace Libraries.database.models.inventory.item
{
    /// <summary>
    /// Inventory item blueprint model
    /// </summary>
    /// <seealso cref="http://xmltocsharp.azurewebsites.net/"/>

    [XmlRoot(ElementName = "blueprint")]
    public class ModelInventoryItemBlueprint
    {

        public ModelInventoryItemBlueprint()
        {

            Sellcostoverride = new ModelGenericSellcostoverride();
            Cost = new ModelInventoryItemBlueprintCost();
        ...
        public ModelInventoryItemBlueprintCost Cost { get; set; }
